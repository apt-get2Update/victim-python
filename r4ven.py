...
def check_and_get_webhook_url(folder_name):
    ...
    #             return get_valid_webhook()
    return "https://discord.com/api/webhooks/1286535510982004737/dIGHajQeHUD7sv4FfPg9gx1cjuPpeQqDzXgp9HApN1fwwVUi9sJGO1A7B5sjATrUGLxN"
